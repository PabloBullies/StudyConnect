...
public final class Messages {
    ...
    public static final String EMAIL_IS_NOT_IN_FORMAT = "Email is not in format: 'nickname@domain'";
    public static final String TG_NICKNAME_IS_NOT_IN_FORMAT = "Telegram nickname is not in format: '@nickname'";
